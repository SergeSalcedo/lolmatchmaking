		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-7 order-2 order-lg-1">
					<h3 class="text-white">Thank you for your feedback!</h3>
				</br>
					<h3 class="text-white">Your message has been submitted</h3>
				</br>
					<form action="contact.php">
						<button class="site-btn">Return<img src="img/icons/double-arrow.png" alt="#"/></button>
					</form>
				</div>
